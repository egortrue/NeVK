...
const std::string MODEL_PATH_2 = "cubemisc/monocube.obj";
const std::string TEXTURE_PATH = "misc/white.jpg";
const std::string MTL_PATH = "misc/";
const std::string MTL_PATH_2 = "cubemisc/";
...
private:
    ...
    void loadModel(const std::string& modelPath, const std::string& mtlPath)
    {
        nevk::Model testmodel;
        std::vector<nevk::Vertex> tempvertices;
        std::vector<uint32_t> tempindices;

        testmodel.loadModel(modelPath, mtlPath, mScene);
        tempvertices = convertVerticesToRender(testmodel.getVertices());
        vertices.insert(vertices.end(), tempvertices.begin(), tempvertices.end());
        //vertices = convertVerticesToRender(testmodel.getVertices());
        tempindices = testmodel.getIndices();
